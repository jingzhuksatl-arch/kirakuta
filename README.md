...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Hiragino Kaku Gothic ProN', 'メイリオ', sans-serif; }
        ...
        .image-gallery img { width: 100%; max-width: 340px; height: 230px; object-fit: cover; border-radius: 8px; box-shadow: 0 3px 8px rgba(0,0,0,0.1); border: 1px solid #eee; }
        .map-container { width: 100%; overflow: hidden; padding-top: 66%; position: relative; border-radius: 8px; }
        .map-container iframe { position: absolute; top: 0; left: 0; width: 100%; height: 100%; border: 0; }
        .contact { display: flex; flex-wrap: wrap; gap: 20px; justify-content: space-around; align-items: center; }
        .contact-item { flex: 1; min-width: 290px; text-align: center; padding: 25px; border: 1px solid #ddd; border-radius: 8px; background: #fafafa; }
        .contact-item h3 { margin-bottom: 10px; color: #333; }
        .contact-item a { display: inline-block; margin-top: 10px; padding: 12px 28px; background: #0052cc; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; }
        ...
        @media (max-width: 680px) { .image-gallery { flex-direction: column; align-items: center; } .contact { flex-direction: column; } }
    </style>
</head>
<body>
    <header>
    ...
    <section>
        ...
        <div class="image-gallery">
            <img src="[https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=400&h=300&fit=crop" alt=](https://github.com/jingzhuksatl-arch/images/commit/996322ace3a47447a4da1cefbfcd449a0215fb8c#diff-c184b1682d41570533a2eebbb71ba3a6073928e79c303b65f9bbb7860e8a2cd0)"オフィス外観イメージ">
            <img src="[https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=400&h=300&fit=crop](https://github.com/jingzhuksatl-arch/images/commit/996322ace3a47447a4da1cefbfcd449a0215fb8c#diff-a3f8473f32a51add02c229ef4dd7eda62b7c0efc7db31ef82d5da99f6d6ac97a)" alt="制御盤・PLCイメージ">
            <img src="[https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=400&h=300&fit=crop](https://github.com/jingzhuksatl-arch/images/commit/996322ace3a47447a4da1cefbfcd449a0215fb8c#diff-9599ce00baaf8066253898df08f1c171b4f6e6ae04b6eea9452a78a2e887d043)" alt="サーボモーター・センサーイメージ">
        </div>
    ...
    <section>
        ...
        <div class="map-container">
            <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3294.151034764316!2d135.23861787585585!3d34.3466340021283!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000b6de7982b779%3A0x26b0c3970bd7230d!2s330-1%20Ishida%2C%20Hannan%2C%20Osaka%20599-0221!5e0!3m2!1sjp!4v1781711520762!5m2!1sjp" 
                style="border:0;" 
                allowfullscreen="" 
                loading="lazy">
            </iframe>
