...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Hiragino Kaku Gothic ProN', 'メイリオ', sans-serif; }
        body { background-color: #f9f9f9; color: #333; line-height: 1.6; padding: 20px; max-width: 960px; margin: 0 auto; }
        ...
        .image-gallery img { width: 100%; max-width: 480px; height: auto; object-fit: cover; border-radius: 5px; box-shadow: 0 3px 6px rgba(0,0,0,0.1); border: 1px solid #eee; }
        .access-info { background: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 4px solid #0052cc; margin-top: 15px; }
        .access-info p { margin-bottom: 8px; }
        .access-info a { color: #0052cc; font-weight: bold; }
        .contact { display: flex; flex-wrap: wrap; gap: 20px; justify-content: space-around; align-items: center; }
        .contact-item { flex: 1; min-width: 190px; text-align: center; padding: 20px; border: 1px solid #ddd; border-radius: 8px; }
        ...
        @media (max-width: 650px) { .image-gallery { flex-direction: column; align-items: center; } .contact { flex-direction: column; } }
    </style>
</head>
<body>
    <header>
    ...
    <section>
        ...
        <div class="image-gallery">
            <img src="https://github.com/jingzhuksatl-arch/kirakuta/commit/1f35b23306691f39e8101c3475d89792c8777b9a#diff-c184b1682d41570533a2eebbb71ba3a6073928e79c303b65f9bbb7860e8a2cd0" alt="オフィス外観イメージ">
            <img src="https://github.com/jingzhuksatl-arch/kirakuta/commit/1f35b23306691f39e8101c3475d89792c8777b9a#diff-a3f8473f32a51add02c229ef4dd7eda62b7c0efc7db31ef82d5da99f6d6ac97a" alt="制御盤・PLCイメージ">
            <img src="https://github.com/jingzhuksatl-arch/kirakuta/commit/1f35b23306691f39e8101c3475d89792c8777b9a#diff-9599ce00baaf8066253898df08f1c171b4f6e6ae04b6eea9452a78a2e887d043" alt="サーボモーター・センサーイメージ">
        </div>
